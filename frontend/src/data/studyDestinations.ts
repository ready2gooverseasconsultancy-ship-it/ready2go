...
import asiaImage from '../assets/images/sinagpore.webp';
...
export const studyDestinations: Record<StudyDestinationKey, StudyDestinationData> = {
  ...
  uae: {
    ...
    shortTitle: 'UAE',
    slug: 'study-in-uae',
    heroImage: countryImages.uae,
    tagline: 'The United Arab Emirates has rapidly emerged as a global education and career destination, offering world-class universities, a thriving job market, and a multicultural lifestyle in cities like Dubai and Abu Dhabi.',
    overview:
      'The UAE has rapidly emerged as a global education and career destination, offering world-class universities, a thriving job market, and a multicultural lifestyle in cities like Dubai and Abu Dhabi. With a growing number of internationally accredited campuses and strong post-graduation employment pathways, the UAE is an increasingly popular choice for students worldwide.',
    quickFacts: [
      'Home to branch campuses of top global universities',
    ...
    whyStudy: [
      'Access globally recognised branch campuses of leading international universities.',
      'Study in a safe, modern environment with excellent career opportunities.',
      'Build a network in a truly multicultural hub with over 200 nationalities.',
      'Benefit from tax-free income and strong post-study employment options.',
    ],
    topUniversities: [
      'Khalifa University',
    ...
    popularCourses: ['Business Administration', 'Engineering', 'Computer Science', 'Aviation', 'Hospitality', 'Finance'],
    admissionProcess: [
      'Research universities and programs that align with your career goals.',
      'Prepare transcripts, English scores, and other required documents.',
      'Submit your application through the university portal or centralized system.',
      'Accept the offer, pay the deposit, and arrange student accommodation.',
    ],
    visaProcess: [
      'Receive your admission confirmation and student visa eligibility letter.',
      'Submit your visa application along with medical and insurance documents.',
      'Complete the biometrics and Emirates ID registration process.',
      'Obtain your student residency visa and plan your travel to the UAE.',
    ],
    costAndScholarships: {
      tuition: 'AED 40,000 - 80,000 per year (approx USD 11,000 - 22,000)',
      living: 'AED 30,000 - 50,000 per year',
      scholarship: 'University merit scholarships and government funding opportunities are available',
      note: 'Costs vary by university, program, and city of residence.',
    },
  },
  singapore: {
    ...
    heroImage: countryImages.singapore,
    tagline: 'Singapore is a global education hub consistently ranking among the top in the world for both universities and quality of life, offering world-class institutions and unmatched career opportunities.',
    overview:
      'Singapore has established itself as one of the world\'s premier education destinations. With top-ranked universities, a strategic location at the heart of Asia, and a thriving economy, Singapore offers students an exceptional educational experience combined with outstanding career prospects and a safe, multicultural environment.',
    quickFacts: [
      'Two of the world\'s top universities: NUS and NTU',
      'English-language instruction across all universities',
      'Global business hub with outstanding career prospects',
      'One of the safest countries in the world',
      'Strategic gateway to Asian markets',
    ],
    whyStudy: [
      'Study at globally top-ranked Asian universities with international recognition.',
      'Benefit from a strategic location as a global business and technology hub.',
      'Access generous scholarship programs and research funding opportunities.',
      'Enjoy a safe, clean, and efficient urban environment with high quality of life.',
    ],
    topUniversities: [
    ...
    popularCourses: ['Business', 'Engineering', 'Computer Science', 'Finance', 'Data Science', 'Biomedical Sciences'],
    admissionProcess: [
      'Choose your preferred university and program based on your academic profile.',
      'Prepare transcripts, test scores (SAT/GRE/GMAT if required), and English proficiency.',
      'Apply through the university admission portal with all supporting documents.',
      'Accept the offer, arrange for student pass processing, and plan accommodation.',
    ],
    visaProcess: [
      'Receive your university offer letter and in-principle approval for Student\'s Pass.',
      'Prepare documents including passport, financial proof, and health insurance.',
      'Submit your Student\'s Pass application through the ICA SOLAR system.',
      'Upon approval, collect your in-principle approval letter and book travel to Singapore.',
    ],
    costAndScholarships: {
      tuition: 'SGD 25,000 - 50,000 per year (approx USD 18,000 - 37,000)',
      living: 'SGD 10,000 - 18,000 per year',
      scholarship: 'Tuition grants, MOE subsidies, and university-specific scholarships are widely available',
      note: 'Singapore\'s tuition grant scheme can significantly reduce costs for eligible students.',
    },
  },
  europe: {
